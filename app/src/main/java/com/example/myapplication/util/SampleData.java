...
public class SampleData implements Serializable {
    ...
    public static class Builder {
        ...
        private @NonNull
        CameraPosition cameraPosition = DefaultConfigs.DEFAULT_CAMERA_POSITION;
        private @NonNull
        CameraResolution cameraResolution = DefaultConfigs.DEFAULT_CAMERA_RESOLUTION;
        private @NonNull
        CameraFocusMode cameraFocusMode = DefaultConfigs.DEFAULT_CAMERA_FOCUS_MODE;
